...
This repository contains the full Power BI project I created while analyzing a soft drink market dataset. The project includes data cleaning, transformation, modeling, DAX calculations, and interactive dashboard development.

The analysis uncovers market dominance patterns, visibility challenges, product distribution gaps, packaging trends, and consumer behavior insights.

---

## 🧠 Story Behind the Project

**Over the past week, I worked on a fascinating soft drink market dataset, and the insights were incredibly revealing. After unpivoting the data, cleaning it, and modeling it in Power BI, I built a dashboard that exposed the real story behind brand performance in the market.**
...
* Market dominance hierarchy
* Brand visibility analysis
* Display strategy effectiveness
* Packaging preference trends
* Outlet type consumption analysis
* Consumer demand distribution curve
* Bottlenecks in brand availability
